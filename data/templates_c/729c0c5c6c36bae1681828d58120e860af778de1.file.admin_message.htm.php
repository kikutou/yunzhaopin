<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-05-24 17:20:32
         compiled from "/var/www/html/yunzhaopin/app/template/admin/admin_message.htm" */ ?>
<?php /*%%SmartyHeaderCode:103189584159255060040b96-43418875%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '729c0c5c6c36bae1681828d58120e860af778de1' => 
    array (
      0 => '/var/www/html/yunzhaopin/app/template/admin/admin_message.htm',
      1 => 1469167086,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '103189584159255060040b96-43418875',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_592550600c2352_17000502',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_592550600c2352_17000502')) {function content_592550600c2352_17000502($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/yunzhaopin/app/include/libs/plugins/modifier.date_format.php';
...
echo $_GET['type'];
          ...
          <div class="admin_Filter_text_box" style="display:none" id='dtype'>
            <ul> 
              ...
              <li><a href="javascript:void(0)" onClick="formselect('2','type','内容')">意见内容</a></li>
            </ul>
          </div>
        </div>
...
"  name='del[]' onclick='unselectall()' rel="del_chk" /></td>
			...
			<a href="javascript:void(0);" onclick="showbox('评论内容','<?php echo $_smarty_tpl->tpl_vars['v']->value['content'];?>
')" class="admin_cz_sc">[更多]</a>
            ...
            <td class="td"> <?php if ($_smarty_tpl->tpl_vars['v']->value['status']=="1") {?>已回复<?php } else { ?><font color="red">未回复</font><?php }?></td>
            <td>
            <?php if ($_smarty_tpl->tpl_vars['v']->value['status']=="0") {?>
           		<a href="?m=admin_message&c=show&id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
