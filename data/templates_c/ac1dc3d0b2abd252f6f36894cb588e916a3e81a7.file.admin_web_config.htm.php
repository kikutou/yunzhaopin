...
<tr class="admin_table_trbg">
    ...
    <td ><div class="admin_td_h">参数值</div></td>
...
echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];
    ...
    <tr class="admin_table_trbg">
		...
		<td>
          ...
          <label for="RadioGroup3_13">关闭</label><span class="admin_web_tip">提示：开启多城市并且绑定域名不支持2级目录，本地测试如 http://localhost/phpyun 请解析测试域名</span>
          </div></td>
...
<div class="hiddendiv"> 
	...
	<tr>
		...
		<td>
         <div class="admin_td_h"><input type="checkbox" name="code_web" value="注册会员" id="checkboxgroup1_0" <?php if (strstr($_smarty_tpl->tpl_vars['config']->value['code_web'],'注册会员')) {?>checked<?php }?>>
        ...
        <label for="checkboxgroup1_2">店铺招聘</label>&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;
        <input type="checkbox" name="code_web" value="职场提问" id="checkboxgroup1_3" <?php if (strstr($_smarty_tpl->tpl_vars['config']->value['code_web'],'职场提问')) {?>checked<?php }?>>
        <label for="checkboxgroup1_3">职场提问</label>
        </div>
          </td>
...
" size="10" maxlength="1" onKeyUp="this.value=this.value.replace(/[^0-9]/g,'')"/><span class="admin_web_tip">提示：字符数不要大于5</span></td>
    ...
    <tr>
		...
		<td>
         <div class="admin_td_h"><input type="radio" name="map_tocity" value="1" id="map_0" <?php if ($_smarty_tpl->tpl_vars['config']->value['map_tocity']=="1") {?>checked<?php }?>>
		    ...
		    <label for="map_1">保持默认坐标</label></div>
        </td>
