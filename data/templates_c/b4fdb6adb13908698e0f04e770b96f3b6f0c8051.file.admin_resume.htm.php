<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-05-24 17:19:50
         compiled from "/var/www/html/yunzhaopin/app/template/admin/admin_resume.htm" */ ?>
<?php /*%%SmartyHeaderCode:355983049592550369d75b4-72182871%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b4fdb6adb13908698e0f04e770b96f3b6f0c8051' => 
    array (
      0 => '/var/www/html/yunzhaopin/app/template/admin/admin_resume.htm',
      1 => 1468284630,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '355983049592550369d75b4-72182871',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59255036ae8ae7_53811467',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59255036ae8ae7_53811467')) {function content_59255036ae8ae7_53811467($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/var/www/html/yunzhaopin/app/include/libs/plugins/function.url.php';
...
function resumttop(id,tid){
	...
	add_class('简历置顶','290','220','#resumttop','');
}
<?php echo '</script'; ?>
>
...
">
      <input type="hidden" name="ids">
		...
		<label>	<span class="admin_resume_dc_s"><input type="checkbox" class="type" name="type[]" value="description"> 个人说明</span></label>
          ...
          <label> <span class="admin_resume_dc_s"><input type="checkbox" class="type" name="rtype[]" value="salary"> 薪水</span></label>
...
"/>
      ...
      <div class="admin_Filter_text formselect" did='dkeytype'>
        <input type="button" <?php if ($_smarty_tpl->tpl_vars['get_type']->value['keytype']==''||$_smarty_tpl->tpl_vars['get_type']->value['keytype']=='1') {?> value="简历名称"  <?php } elseif ($_smarty_tpl->tpl_vars['get_type']->value['keytype']=='2') {?> value="EMAIL" <?php } elseif ($_smarty_tpl->tpl_vars['get_type']->value['keytype']=='3') {?> value="手机号" <?php }?> class="admin_Filter_but" id="bkeytype">
        ...
        <div class="admin_Filter_text_box" style="display:none" id="dkeytype">
          <ul> 
            ...
            <li><a href="javascript:void(0)" onClick="formselect('2','keytype','EMAIL')">EMAIL</a></li>
        ...
        <table width="100%">
          <thead>
            <tr class="admin_table_top">
              ...
              <th width="100">简历名称</th>
			  <th width="100">用户姓名</th>
              <th width="150">意向职位</th>
              <th>工作地点</th>
              <th>待遇要求</th>
              <th>工作性质</th>
              <th>到岗时间</th>
...
" target="_blank" class="admin_cz_sc"><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
            ...
            <td class="od" align="left"><?php echo $_smarty_tpl->tpl_vars['v']->value['job_post_n'];?>
...
个</font></a>)</td>
            <!--onclick="show_job_name('<?php echo $_smarty_tpl->tpl_vars['v']->value['job_class_name'];?>
')"-->
            <td class="gd" align="left"><?php echo $_smarty_tpl->tpl_vars['v']->value['cityid_n'];?>
</td>
            <td class="td" align="left"><?php echo $_smarty_tpl->tpl_vars['v']->value['salary_n'];?>
</td>
            ...
            <td><?php if ($_smarty_tpl->tpl_vars['v']->value['source']==1) {?>网页<?php } elseif ($_smarty_tpl->tpl_vars['v']->value['source']==2) {?>WAP<?php } elseif ($_smarty_tpl->tpl_vars['v']->value['source']==3) {?>APP<?php } elseif ($_smarty_tpl->tpl_vars['v']->value['source']==4) {?>微信<?php } elseif ($_smarty_tpl->tpl_vars['v']->value['source']==5) {?>PC<?php } elseif ($_smarty_tpl->tpl_vars['v']->value['source']=="6") {?>采集<?php } elseif ($_smarty_tpl->tpl_vars['v']->value['source']=="7") {?>Execl<?php }?></td>
...
"><?php if ($_smarty_tpl->tpl_vars['v']->value['top']=="1"&&$_smarty_tpl->tpl_vars['v']->value['topdate']>time()) {?><a href="javascript:void(0);" onClick="resumttop('<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['v']->value['top_day'];?>
')"><img src="../config/ajax_img/doneico.gif"></a><?php } else { ?><a href="javascript:void(0);" onClick="resumttop('<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['v']->value['top_day'];?>
')"><img src="../config/ajax_img/errorico.gif"></a><?php }?></td>
...
');" title="刷新" class="admin_cz_sc">刷新</a><br/><a href="index.php?m=admin_resume&c=saveresume&uid=<?php echo $_smarty_tpl->tpl_vars['v']->value['uid'];?>
