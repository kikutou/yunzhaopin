...
{\/yun}')">内部调用</a> | 
            <a href="javascript:void(0);" onClick="copy_url('外部调用','&lt;script src=\'<?php echo smarty_function_url(array('m'=>'ajax','c'=>'yunimg','classid'=>$_smarty_tpl->tpl_vars['v']->value['class_id'],'ad_id'=>$_smarty_tpl->tpl_vars['v']->value['id']),$_smarty_tpl);?>
